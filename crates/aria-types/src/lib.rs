...
//! ## Module Structure
//!
//! - [`types`] - Core type enum, effects, constant values
//! - [`check_mode`] - Bidirectional type checking modes
//! - [`errors`] - Type error definitions
//! - [`type_defs`] - Type environment, bounds, traits, schemes
//! - [`inference`] - Type inference engine (unification, substitution)
//! - [`narrowing`] - Flow-sensitive type narrowing
//! - [`captures`] - Closure capture analysis types
