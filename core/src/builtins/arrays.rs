...
/// Usage: arr_len(arr: string) -> number
...
/// Usage: arr_get(arr: string, index: number) -> string
...
/// Usage: arr_join(arr: string, delim: string) -> string
...
/// Usage: arr_push(arr: string, item: string) -> string (new array)
...
/// Usage: arr_pop(arr: string) -> string (new array)
